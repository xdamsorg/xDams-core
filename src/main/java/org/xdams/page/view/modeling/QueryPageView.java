...
// test data multipla in ricerca --- outputField += "<div class=\"ml20\"><input type=\"text\" onblur=\"return findDate(document.theForm,'normalize',this,'day')\" class=\"data\" size=\"3\" name=\"giorno_ini"+nameValue+"\" maxlength=\"2\" />&#160;/&#160;<input type=\"text\" onblur=\"return findDate(document.theForm,'normalize',this,'month')\" class=\"data\"  size=\"3\" name=\"mese_ini"+nameValue+"\" maxlength=\"2\" />&#160;/&#160;<input type=\"text\" onblur=\"return findDate(document.theForm,'normalize',this,'year')\" class=\"data\" name=\"anno_ini"+nameValue+"\" maxlength=\"4\" />&#160;-&#160;<input type=\"text\" onblur=\"return findDate(document.theForm,'normalize',this,'day')\" class=\"data\"  size=\"3\"  name=\"giorno_fin"+nameValue+"\" maxlength=\"2\" />&#160;/&#160;<input type=\"text\" onblur=\"return findDate(document.theForm,'normalize',this,'month')\" class=\"data\"  size=\"3\" name=\"mese_fin"+nameValue+"\" maxlength=\"2\" />&#160;/&#160;<input type=\"text\" onblur=\"return findDate(document.theForm,'normalize',this,'year')\" class=\"data\" name=\"anno_fin"+nameValue+"\" maxlength=\"4\" />&#160;&#160;&#160;<input type=\"checkbox\" name=\"dataEsatta"+nameValue+"\" />"+workFlowBean.getLocalizedString("esatta","esatta")+"</div>\n";
