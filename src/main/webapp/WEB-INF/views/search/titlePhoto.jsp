 ...
 <div class="jcarousel-wrapper">
	...
	<ul class="wrapDida">
	 ...
	 <ul class="btThumbOn">
		...
		<li><a href="${contextPath}/editing/${workFlowBean.alias}/docEdit.html?physDoc=<%=physDoc%>&amp;thePne=${workFlowBean.archive.pne}&amp;pos=<%=pos%>&amp;selid=<%=qRParser.getIdQR()%>" title="<spring:message code="apri_scheda_modifica" text="apri la scheda di modifica"/>" target="_new${workFlowBean.alias}"><img src="${frontUrl}/img/titlePhoto/btScheda.jpg" /></a></li>
		<%
		if(imageViewer){
		%>
