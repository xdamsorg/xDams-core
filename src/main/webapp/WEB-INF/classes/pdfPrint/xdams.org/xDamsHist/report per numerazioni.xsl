				...
				<fo:static-content flow-name="xsl-region-after">
					<fo:table table-layout="fixed" width="28cm">
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell>
									<fo:block line-height="10pt" font-size="8pt" text-align="left">xDams OpenSource: Elenco per numerazioni</fo:block>
								</fo:table-cell>
								<fo:table-cell>
					...
					<fo:block>
						<fo:table table-layout="fixed" width="28cm" space-before="15pt">
							...
							<fo:table-header>
								<fo:table-row>
									<fo:table-cell>
										<fo:block font-size="8pt" font-weight="bold" text-align="center" margin-bottom="10pt">id</fo:block>
									</fo:table-cell>
									<fo:table-cell>
										<fo:block font-size="8pt" font-weight="bold" text-align="center" margin-bottom="10pt"># provv.</fo:block>
									</fo:table-cell>
									<fo:table-cell>
										<fo:block font-size="8pt" font-weight="bold" text-align="center"># def.</fo:block>
									</fo:table-cell>
									<fo:table-cell>
								...
								<fo:table-body>
									<fo:table-row>
										...
										<fo:table-cell border-bottom="0.5pt solid orange">
											<fo:block font-size="9pt" font-weight="normal" color="black" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt" keep-together="always">
												<fo:block-container width="5.4cm" overflow="hidden">
													<fo:block>
