		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="simpleA4">
				<fo:static-content flow-name="xsl-region-after">
					<fo:table table-layout="fixed" width="18cm">
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell>
									<fo:block line-height="10pt" font-size="8pt" text-align="left">xDams OpenSource - Inventario sintetico (livelli alti)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						<xsl:for-each select="//c[@level!='file' and @level!='item' and not(./@otherlevel)]">
