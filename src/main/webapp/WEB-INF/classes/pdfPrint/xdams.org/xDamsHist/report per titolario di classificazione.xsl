				...
				<fo:static-content flow-name="xsl-region-after">
					<fo:table table-layout="fixed" width="28cm">
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell>
									<fo:block line-height="10pt" font-size="8pt" text-align="left">xDams OpenSource: Elenco per titolario di classificazione</fo:block>
								</fo:table-cell>
								<fo:table-cell>
					...
					<fo:block>
						<fo:table table-layout="fixed" width="28cm" space-before="15pt">
							...
							<fo:table-header>
								<fo:table-row>
									<fo:table-cell>
										<fo:block font-size="8pt" font-weight="bold" text-align="center" margin-bottom="10pt">titolario di classificazione</fo:block>
									</fo:table-cell>
									<fo:table-cell>
									...
									<fo:table-row>
										<fo:table-cell border-bottom="0.5pt solid orange" border-right="0.5pt solid orange">
											<fo:block font-size="9pt" font-weight="normal" color="black" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
												<xsl:apply-templates select="./descgrp/fileplan/p"/>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell border-bottom="0.5pt solid orange" border-right="0.5pt solid orange">
											<fo:block font-size="9pt" font-weight="normal" color="black" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
										...
										<fo:table-cell border-bottom="0.5pt solid orange">
											<fo:block font-size="9pt" font-weight="normal" color="black" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
												<fo:block-container width="4.6cm" overflow="hidden">
													<fo:block>
