								...
								<fo:table-body>
									...
									<xsl:if test="./@level">
										<fo:table-row>
											...
											<fo:table-cell border-bottom="0.5pt solid darkblue">
												<fo:block font-size="10pt" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
													<xsl:if test="./@level='fonds'">fondo</xsl:if>
													<xsl:if test="./@level='collection'">collezione</xsl:if>
													<xsl:if test="./@level='recordgrp'">raccolta</xsl:if>
													<xsl:if test="./@level='file'">opera complessa/seriale</xsl:if>
													<xsl:if test="./@level='item'">opera singola/isolata</xsl:if>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
									</xsl:if>
																				...
																				<fo:table-cell border-bottom="0.5pt solid darkblue" border-top="0.5pt solid darkblue">
																					<xsl:for-each select="./originalsloc/p">
																						<fo:block font-size="10pt" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
																							...
																							<xsl:if test="./date/text() !=''"> (<xsl:apply-templates select="./date/text()"/>)</xsl:if>
																						</fo:block>
																					</xsl:for-each>
																				</fo:table-cell>
																			</fo:table-row>
																			...
																			<fo:table-row>
																				...
																				<fo:table-cell border-bottom="0.5pt solid darkblue">
																					<fo:block font-size="10pt" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
																						...
																						<xsl:if test="./did/repository/address/addressline/text()">&#160;-&#160;<xsl:apply-templates select="./did/repository/address/addressline[1]/text()"/>&#160;-&#160;<xsl:apply-templates select="./did/repository/address/addressline[2]/text()"/>
																						</xsl:if>
																					</fo:block>
																				</fo:table-cell>
																			</fo:table-row>
																			...
																			<fo:table-row>
																				...
																				<fo:table-cell border-bottom="0.5pt solid darkblue">
																					<xsl:for-each select="./did/physloc[@encodinganalog='LDC']">
																						<fo:block font-size="10pt" start-indent="3pt" end-indent="3pt" margin-bottom="3pt" margin-top="3pt">
																							<xsl:apply-templates select="./text()"/>
																							<xsl:if test="./@altrender">&#160;-&#160;<xsl:apply-templates select="./@altrender"/>
																							</xsl:if>
																							<xsl:if test="./emph/text()">
																								<fo:inline>&#160;(<xsl:apply-templates select="./emph/text()"/>)</fo:inline>
																							</xsl:if>
																						</fo:block>
																					</xsl:for-each>
																				</fo:table-cell>
...
Funzionario responsabile:&#160;<xsl:apply-templates select="./processinfo/p/persname/text()"/>	</xsl:if>
