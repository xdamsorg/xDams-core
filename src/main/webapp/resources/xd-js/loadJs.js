...
function loadJsBusiness(target, prefix) {
	...
	if (target === 'workspace') {
		loadScripts({
			'base' : base + "/jquery",
			'prefix' : prefix,
			'scripts' : [ 'jquery-ui-last', 'jquery.cookie', 'jquery.i18n.properties' ]
		});
		loadScripts({
			'base' : base,
			'prefix' : prefix,
		...
		loadScripts({
			'base' : base + "/jquery",
			'prefix' : prefix,
			'scripts' : [ 'jquery-ui-last', 'jquery.autocomplete-1.4.2', 'jquery.jgrowl_minimized', 'jquery.blockUI', 'jquery.cookie', 'jquery.i18n.properties' ]
		});
		loadScripts({
			'base' : base,
			'prefix' : prefix,
		...
		loadScripts({
			'base' : base + "/jquery",
			'prefix' : prefix,
			'scripts' : [ 'jquery-ui-last', 'jquery.autocomplete-1.4.2', 'jquery.jgrowl_minimized', 'jquery.blockUI', 'jquery.cookie','jquery.qtip.min', 'jquery.i18n.properties' ]
		});
		loadScripts({
			'base' : base,
			'prefix' : prefix,
		...
		loadScripts({
			'base' : base + "/jquery",
			'prefix' : prefix,
			'scripts' : [ 'jquery-ui-last', 'jquery.i18n.properties' ]
		});
		loadScripts({
			'base' : base,
			'prefix' : prefix,
		...
		loadScripts({
			'base' : base + "/jquery",
			'prefix' : prefix,
			'scripts' : [ 'jquery-ui-last', 'jquery.bgiframe.min', 'jqModal', 'jquery.jgrowl_minimized', 'jquery.dimensions', 'jquery.cookie','jquery.qtip.min', 'jquery.i18n.properties' ]
		});
		loadScripts({
			'base' : base,
			'prefix' : prefix,
		...
		loadScripts({
			'base' : base + "/jquery",
			'prefix' : prefix,
			'scripts' : [ 'jquery-ui-last', 'jquery.blockUI', 'jquery.bgiframe.min', 'jquery.dimensions', 'jqModal', 'jquery.jgrowl_minimized', 'jquery.cookie','jquery.qtip.min','jquery.jcarousel.min', 'jquery.i18n.properties' ]
		});
		loadScripts({
			'base' : base,
			'prefix' : prefix,
